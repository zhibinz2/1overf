...
def DFA_main(DATA):
    ...
    win_lengths = np.arange(10, len(DATA)/2, 10).astype(int) # how many different win_lengths, customized to your data
...
savemat('Hurst_eeg_200_10_'+str(filedates[0]),outdict,store_python_metadata = True) 
